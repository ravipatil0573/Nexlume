...
import "./OrbitingSkillsBanner.css";

// ============================================
// ORBITING SKILLS BANNER - START
// ============================================

// Icon Components with SVG logos
...
const skillsConfig = [
  { id: "html", orbitRadius: 80, size: 32, speed: 1, iconType: "html", phaseShift: 0, glowColor: "cyan", label: "HTML5" },
  { id: "css", orbitRadius: 80, size: 36, speed: 1, iconType: "css", phaseShift: (2 * Math.PI) / 3, glowColor: "cyan", label: "CSS3" },
  { id: "javascript", orbitRadius: 80, size: 32, speed: 1, iconType: "javascript", phaseShift: (4 * Math.PI) / 3, glowColor: "cyan", label: "JavaScript" },
  { id: "react", orbitRadius: 140, size: 40, speed: -0.6, iconType: "react", phaseShift: 0, glowColor: "purple", label: "React" },
  { id: "node", orbitRadius: 140, size: 36, speed: -0.6, iconType: "node", phaseShift: (2 * Math.PI) / 3, glowColor: "purple", label: "Node.js" },
  { id: "tailwind", orbitRadius: 140, size: 32, speed: -0.6, iconType: "tailwind", phaseShift: (4 * Math.PI) / 3, glowColor: "purple", label: "Tailwind CSS" },
];
...
export default function OrbitingSkillsBanner() {
  ...
  return (
    <div className="orbiting-skills-banner">
      ...
      <div className="banner-container">
        <div className="banner-header">
          <h2 className="banner-title">
            Tech{" "}
            <span className="banner-title-gradient">
              Arsenal
            </span>
          </h2>
          <p className="banner-subtitle">Technologies I work with</p>
        </div>

        <div className="banner-orbit-container">
          <div
          ...
          >
            <div className="center-icon-wrapper">
              <div className="center-icon-glow-cyan"></div>
              <div className="center-icon-glow-purple"></div>
